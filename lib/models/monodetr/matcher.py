...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        #print(cost_class.shape)[400, 106]   意思就是
        ...
        #print(cost_3dcenter.shape) [400, 106]
        ...
        #print(cost_bbox.shape) ([400, 106]) 
        #print(tgt_2dbbox.shape)106, 4])
        ...
        #print(C.shape)([8, 50, 106]) 
        sizes = [len(v["boxes"]) for v in targets] 
        #print(sizes)#   [7, 1, 31, 12, 14, 4, 23, 14]  
        #print(C.split(sizes, -1)[0].shape) [8, 50, 7]
        #print(C.split(sizes, -1))
        #print(i for i, c in enumerate(C.split(sizes, -1)))
        #print(c for i, c in enumerate(C.split(sizes, -1)))
